...
# 문제12
myemp[myemp$job=='SALESMAN',]
subset(myemp, subset=myemp$job=='SALESMAN')
subset(myemp, myemp$job=='SALESMAN')

# 문제13
subset(myemp, c('ename', 'sal', 'job'), subset=myemp$sal>=1000 &myemp$sal<=3000)
subset(myemp, sal>=1000 &sal<=3000, c('ename', 'sal', 'job'))
myemp[myemp$sal>=1000 & myemp$sal<=3000, c('ename', 'sal', 'job')]
